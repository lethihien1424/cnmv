...
//   const [shippingMethod,    setShippingMethod]    = useState<'GHN' | 'EXPRESS'>('GHN');
...
//       const method = shippingMethod === 'EXPRESS' && res.express.available ? 'EXPRESS' : 'GHN';
//       if (method !== shippingMethod) setShippingMethod('GHN');
...
//   const handleMethodChange = (method: 'GHN' | 'EXPRESS') => {
...
//                     {/* GHN */}
//                     <button className={`ship-btn ${shippingMethod==='GHN'?'active-ghn':''}`} onClick={() => handleMethodChange('GHN')} disabled={!shippingOptions}>
...
//                       </div>
//                       <span className="ship-badge" style={{ background:shippingMethod==='GHN'?'#ede9fe':'#f1f5f9', color:shippingMethod==='GHN'?'#7c3aed':'#64748b' }}>GHN</span>
//                     </button>
//                     {/* Express */}
